...
class _RegisterState extends State<Register> {
  ...
  upLoadToStorage() async {
    ...
    String imageFiledName = DateTime.now().millisecondsSinceEpoch.toString();
    ...
    print('ok');
    //ここが機能してくれないから画像urlがアップされない
    String imgurl = await (await storageUpLoadTask).ref.getDownloadURL();
    //
    userImageUrl = imgurl;
 ...
 _registerUser()async{
  ...
  Future saveUserInfoToFireStore(User fUser)async{
    FirebaseFirestore.instance.collection('users').doc(fUser.uid).set({
      ...
      'url':userImageUrl,
      EcommerceApp5.userCartList:["garbageValue"]
    });
